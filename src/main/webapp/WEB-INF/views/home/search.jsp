...
<body style="padding-top: 180px">
	...
	<div class="container">
		...
		<span style="font-size:20px;font-weight: bold;">스토어</span> <span style="float:right">더보기</span>
		<hr>
				...
				<div id="table" class="row text-center"
					...
					<c:forEach items="${gsearch}" var="gs">
						<div class="product-item col-sm-3">
							<div class="pi-pic">
								<img src="/resources/img/admin/goods/${gs.thumbnail}" alt=""
									style="width: 160px; height: 230px; border-radius: 6px;">
							</div>
							<div class="pi-text">
								<h6>${gs.goodsname}</h6>
								<div class="product-price">${gs.price}원</div>
							</div>
						</div>
					</c:forEach>
					
					
				</div> <span style="font-size:20px;font-weight: bold;">노하우</span> <span style="float:right">더보기</span>
				<hr>
						...
						<span style="font-size:20px;font-weight: bold;">질문과 답변</span> <span style="float:right">더보기</span>
						<hr>
