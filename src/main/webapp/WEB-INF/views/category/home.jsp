					...
					<div class="sidebar" style="display: block;">
						...
						<ul class="nav">
							<li class="submenu"><a href="#" style="font-size: 25px;">
								...
								<ul>
									<c:forEach items="${smallcategory}" var="vo2" begin="7"
										end="13">
										<li><a href="#" style="font-size: 18px;"
						...
						<ul class="nav">
							<li class="submenu"><a href="#" style="font-size: 25px;">
								...
								<ul>
									<c:forEach items="${smallcategory}" var="vo3" begin="14"
										end="17">
										<li><a href="#" style="font-size: 18px;"
						...
						<ul class="nav">
							<li class="submenu"><a href="#" style="font-size: 25px;">
								...
								<ul>
									<c:forEach items="${smallcategory}" var="vo4" begin="18"
										end="24">
										<li><a href="#" style="font-size: 18px;"
						...
						<ul class="nav">
							<li class="submenu"><a href="#" style="font-size: 25px;">
								...
								<ul>
									<c:forEach items="${smallcategory}" var="vo5" begin="25"
										end="29">
										<li><a href="#" style="font-size: 18px;"
						...
						<ul class="nav">
							<li class="submenu"><a href="#" style="font-size: 25px;">
								...
								<ul>
									<c:forEach items="${smallcategory}" var="vo6" begin="30"
										end="36">
										<li><a href="#" style="font-size: 18px;"
				...
				<div class="col-lg-9">
					<div class="row">
						...
						<div id="input">
							...
							<div class="dropdown">
								<button type="button"
									style="font-size: 20px; color: black; background-color: white; border: none;"
									class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
									전체</button>
								<div class="dropdown-menu">
									<a class="dropdown-item" style="font-size: 20px;"
										href="/category/home">최신순</a> <a class="dropdown-item"
										style="font-size: 20px;" href="#"
										onclick="select_submit('rowprice')">가격 낮은순</a> <a
										class="dropdown-item" style="font-size: 20px;" href="#"
										onclick="select_submit('highprice')">가격 높은순</a> <a
										class="dropdown-item" style="font-size: 20px;" href="#"
										onclick="select_submit('highstar')">별점 높은순</a>
