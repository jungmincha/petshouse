								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" id="psize" class="form-control"
											aria-describedby="sizeHelp" value="${goods.psize}"> <small
								...
								<div class="form-group row">
									...
									<div class="col-sm-offset-2 col-sm-6">
										<input type="button" class="btn btn-block"
											style="background-color: #e7ab3c" value="상품목록" onClick="location.href='${pageContext.request.contextPath}/admin/goods'">
