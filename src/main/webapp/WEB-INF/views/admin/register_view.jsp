			...
			<fieldset>
				<table class="table_center" cellpadding="20">
					...
					<div class="input-group col-sm-9">
						  ...
						  <input type="file" class="custom-file-input" id="thumbnail" name="thumbnail" style="display: block;">	
						   <label class="custom-file-label" for="inputGroupFile02">Choose file</label></div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									...
									<label>2차 분류</label> 
									<select class="category2" name="categoryVO.category_id" class="form-control" style="vertical-align: middle; text-align-last: center">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<select name="stockVO.stock_id" style="vertical-align: middle; text-align-last: center">
