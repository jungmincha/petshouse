								...
								<div class="product-thumbs">
									...
									<%-- 	<c:forEach var="goods" items="${goods.content}">
										...
										<div class="pt" data-imgbigurl="/resources/img/file/cat2.jpg">
											<img src="/resources/img/file/cat2.jpg" alt="">
										</div>
										<div class="pt" data-imgbigurl="/resources/img/file/cat1.jpg">
										...
										<div class="product-content">
											<div class="row">
												<div class="col-lg-7">
													...
													<p>어대공에서 살고 있는 냥냥이</p>
													<h5>Features</h5>
													<p>길 알려달라고 해도 쿨하게 씹어주시는 냥냥이${goods.content}</p>
												</div>
												<div class="col-lg-5">
													<img src="/resources/img/file/cat1.jpg" alt="">
												</div>
												...
												<tbody>
													<tr>
														...
														<td><p>
																...
																인터넷뱅킹, 텔레뱅킹 혹은 가까운 은행에서 직접 입금하시면 됩니다. &nbsp;<br>주문
