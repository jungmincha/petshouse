				...
				<div id="input">
					...
					<div class="col-lg-8">
						<a class="btn  col-sm-1 "
							style="background-color: #FFC81E;  color:black; position: fixed; top: 80px; right: 30px;"
							href="/admin/board/registerView">상품게시글<br>등록</a> <a
							class="btn  col-sm-1 "
							style="background-color: #FFC81E;  color:black; position: fixed; top: 150px; right: 30px;"
