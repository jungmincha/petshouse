...
<a class="btn col-sm-1 float-right"  id = "login"  style="background-color: #FFC81E;  color:black; position: fixed; top: 170px; right: 30px;" onclick="location.href='${pageContext.request.contextPath}sns/write_view'">게시글등록</a>
