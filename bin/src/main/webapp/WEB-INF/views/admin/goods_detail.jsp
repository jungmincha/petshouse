			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<input type="hidden" name="goods_id"
						value="${goods.goodsVO.goods_id}">
					<div style="float: right">
						<sec:authorize access="hasAnyRole('ROLE_ADMIN')">
							<button type="button" id="delete_button" class="btn"
								style="background-color: #FFC81E; color: black;"
						...
						<div class="product-thumbs">
							<div class="product-thumbs-track ps-slider owl-carousel ">
								<div class="pt active"
									...
									<img
										src="/resources/img/admin/goods/${goods.goodsVO.thumbnail}"
										style="width: 140px; height: 150px; object-fit: cover;" alt="">
								</div>
								<c:forEach var="goods" items="${img}">
									<div class="pt"
										...
										<img src="/resources/img/admin/board/${goods.imgname}"
											style="width: 140px; height: 150px; object-fit: cover;"
											alt="">
									</div>
								</c:forEach>
							</div>
					...
					<div class="col-lg-6" style="padding-left: 40px;">
						<div class="product-details">
							<div class="pd-title">
								<input type="hidden" name="board_id" value="${goods.board_id}">
								<input type="hidden" name="goods_id"
									value="${goods.goodsVO.goods_id}"> <input type="hidden"
									name="goods_id" value="${goods.pdate}"> <span>${goods.categoryVO.categoryname}/${goods.categoryVO.sortname}</span>
				...
				<div class="tab-item">
					<ul class="nav" role="tablist">
						...
						<li><a data-toggle="tab" href="#tab-2" role="tab"
							style="width: 335px; text-align: center;"> 고객리뷰 </a></li>
						<li><a data-toggle="tab" href="#tab-3" role="tab"
							style="width: 330px; text-align: center;">주문가이드</a></li>
					</ul>
				</div>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td><p>
													[교환/반품 안내]<br>물품 수령 후(택배 도착일자 기준) 7일 이내에 Q&amp;A "배송 후
													교환/반품" 게시판 또는 고객센터 [070-7000-0000]
												</p>
												<p>
													로 반드시 접수 해주세요. 글쓰기시 양식이 자동으로 등록되어 있으며, 사전에 신청해 주신 상품에 한해서만
													교환/반품이 가능합니다.<br>접수 시 펫츠하우스에서 우체국 택배 회수접수를 도와드리고 있습니다.
												</p>
												...
												<p>
													...
													구매시 교환/환불 불가능이 명시되어 있는경우<br>-사용 흔적(집냄새,향수냄새,체취) / 텍 제거
													및 바코드 훼손, 오염이 발견된 상품<br>-세일상품
												</p>
						...
						success : function(data) {
							...
							for ( var i in review) {
								html += "<div class='co-item'><div class='avatar-text'><div class='at-rating'><div class='row'><div class='profile_box'>"
										...
										+ "<b>"
										+ review[i].memberVO.nickname
										+ "</b>"
										+ "<span class='star-prototype'> <span class='star' style='width:"
										+ (review[i].ratescore * 16)
										+ "px'> </span></div></div></div>"
